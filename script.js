//Create a function that accepts a number and its number system, then convert it into a specified number system.//
...
//Create a function that accepts a date in DD/MM/YY format and identify the month of the said date.//
